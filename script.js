...
const Pin = () => {
    ...
    const getCancelText = () => {
        return (React.createElement("span", { id: "app-pin-cancel-text", onClick: handleOnCancel }, "Annuler"));
    };
...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "Comment ça se passe là-bas ?" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-toolbox", id: "tools-section", title: "Que se passe-t-il ?" }, getTools()));
};
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                desc: "Les meilleurs hamburgers de la ville",
                id: 1,
                ...
                desc: "Le barbecue n'a pas besoin de rime",
                id: 4,
    ...
    return (React.createElement(MenuSection, { icon: "fa-regular fa-pot-food", id: "restaurants-section", title: "Faites-vous livrer !" }, getRestaurants()));
};
const Movies = () => {
    const getMovies = () => {
        return [{
                desc: "L'histoire de certaines personnes qui veillent sur une grande partie de l'espace.",
                id: 1,
                ...
                title: "Protecteurs de la Voie Lactée"
            }, {
                desc: "Certaines personnes quittent leurs trous pour perturber certaines choses.",
                id: 2,
                ...
                title: "Les gens du trou"
            }, {
                desc: "Un garçon avec une bosse sur la tête tente d'arrêter un méchant. Et par méchant, j'entends qu'il est incapable de gagner.",
                id: 3,
                ...
                title: "Pot de cheveux"
            }, {
                desc: "Une longue histoire de gens qui se disputent un peu d'espace. Parce qu'il n'y en a pas assez.",
                id: 4,
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-camera-movie", id: "movies-section", scrollable: true, title: "C'est l'heure du pop-corn !" }, getMovies()));
};
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://www.youtube.com/@w3schools", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "@w3schools")),
